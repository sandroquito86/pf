...
class RecetaVeterinariaLinea(models.Model):
    _name = 'mz.receta.veterinaria.linea'
    _description = 'Línea de Receta Médica'

    servicio_veterinario_id = fields.Many2one('mz.servicio.veterinario', string='Servicio', required=True, ondelete='cascade')
    ...
    @api.depends('servicio_veterinario_id')
